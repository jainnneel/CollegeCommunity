 ...
 <header>
       	    <div class="container ">
				 ...
				 <div class=" profile-user-settings ml-4">
                     ...
                     %>
                       <div>
                        <button class="btn  profile-edit-btn px-5" id="follow" onclick="dofollow(<%=luid%>,<%=puid%>)">follow</button>
                      </div> 
                      <%
						 }
						else
						{
						 %>
                         <div>
                        <button class="btn profile-edit-btn px-5" id="follow" onclick="dofollow(<%=luid%>,<%=puid%>)">following</button>
                      </div>   
                      <%} %>
                    </div>
                    <br>
